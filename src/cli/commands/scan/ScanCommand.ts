...
class ScanCommandImpl implements Abstraction.Interface {
    ...
    public steps(): Step.Interface[] {
        return [this.detectPackageManager, this.loadConfig, this.parseLockfile, this.checkLicenses];
    }
...
export const ScanCommand = Abstraction.createImplementation({
    ...
    dependencies: [DetectPackageManagerStep, LoadConfigStep, ParseLockfileStep, CheckLicensesStep]
});
